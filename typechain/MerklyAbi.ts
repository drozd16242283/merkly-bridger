...
export interface MerklyAbiInterface extends utils.Interface {
  functions: {
    "DEFAULT_PAYLOAD_SIZE_LIMIT()": FunctionFragment;
    "FUNCTION_TYPE_SEND()": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "bridgeGas(uint16,address,bytes)": FunctionFragment;
    ...
    "estimateGasBridgeFee(uint16,bool,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "estimateGasBridgeFee",
    values: [
      PromiseOrValue<BigNumberish>,
  ...
  decodeFunctionResult(functionFragment: "bridgeGas", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "clearCredits",
    data: BytesLike
  ): Result;
